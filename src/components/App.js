...
useEffect(() => { 
  ...
  return (
    <div className="App">
      ...
      <NavBar/>
        <Routes>
          <Route exact path="/" element={<Home properties={properties}  setSort={setSort} getLocation={getLocation} showPosition={showPosition} currentPage={currentPage} setCurrentCity={setCurrentCity} setCurrentPage={setCurrentPage} currentState={currentState} setCurrentState={setCurrentState} getFavorites={getFavorites} setMap={setMap} map={map}/>}>
          </Route>
